...
with open(file=data_file, mode='r+') as invoices:
    last_line = record_invoice(invoice_file=invoices, company='ACME Roadrunner', amount=18.40)
    last_line = record_invoice(invoice_file=invoices, company='Squirrel Storage', amount=320.55,
                               last_line_pointer=last_line)
